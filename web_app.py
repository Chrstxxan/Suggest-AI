...
def chat():
    if request.method == "POST":
        ...
        resposta = recomendar_por_chat(frase, recommender, top_n)
        return render_template("result.html", nome=nome, recs=resposta if isinstance(resposta, list) else [], modo="chat")
